...
![Local validation demo](https://github.com/tosin2013/jupyter-notebook-validator-operator/releases/download/v1.0.10/local-validation.gif)
...
![OpenShift deployment demo](https://github.com/tosin2013/jupyter-notebook-validator-operator/releases/download/v1.0.10/openshift-deploy.gif)
...
![Laptop to cluster demo](https://github.com/tosin2013/jupyter-notebook-validator-operator/releases/download/v1.0.10/laptop-to-cluster.gif)
